...
* `Country` data is _completely_ unusable for many reasons, first and foremost because it was treated as a free-text field at the point of data entry — most inconsistencies and errors have this to blame — but also due to the labelling of Canadian locations as American (that's ~96% of the dataset obsolete), and the use of outdated choronyms (e.g. _West Germany_, _Burma_, _Swaziland_, etc.) owing to the database's age.
...
### Data cleansing
Cleanup, as per usual, consumed the majority of my time with this project.
